<?php
class Model_Siwarga extends CI_Model {
...
//***********************************************Warga****************************************
	...
	function update_data_warga($data){
		$query = $this->db->query("Update warga set nama='".$data['nama']."',tmp_lahir='".$data['tmp_lahir']."',tgl_lahir='".$data['tgl_lahir']."',telp='".$data['telp']."' ,status='".$data['status']."',rt='".$data['rt']."',rw='".$data['rw']."' where nik = '".$data['nik']."'");
		return true;
	}
...
//*****************************************Emergency****************************************
	...
	function update_data_emergency($data){
		$query = $this->db->query("Update emergency set tanggal='".$data['tanggal']."',lokasi='".$data['lokasi']."',pelapor='".$data['pelapor']."',keterangan='".$data['keterangan']."' ,status='".$data['status']."' where id_emergency = '".$data['id_emergency']."'");
		return true;
	}
