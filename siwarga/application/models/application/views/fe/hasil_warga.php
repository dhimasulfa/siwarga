...
<section class="service_area" id="service">
                    ...
                    <?php echo form_open('Siwarga_fe/search') ?>
                        <input class="search" type="text" name="keyword" placeholder="Masukkan NIK" disabled>
                        <input class="button" type="submit" name="search_submit" value="Cari">
                        <a class="bt_reset" href="<?php echo base_url('Siwarga_fe'); ?>">Reset</a>
                    <?php echo form_close() ?>
